...
Rails.application.config.assets.precompile += %w( jquery.barfiller.js )
Rails.application.config.assets.precompile += %w( bootstrap.min.css )
Rails.application.config.assets.precompile += %w( style.css )
Rails.application.config.assets.precompile += %w( bars-style.css )
...
Rails.application.config.assets.precompile += %w( vertical-rhythm.min.css )
...
Rails.application.config.assets.precompile += %w( jquery.viewport.mini.js )
...
Rails.application.config.assets.precompile += %w( http://maps.google.com/maps/api/js?sensor=false&amp;language=en )
...
Rails.application.config.assets.precompile += %w( contact-form.js )
